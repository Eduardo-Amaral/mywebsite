...
function Projects() {
    return (
        <div className="container pt-5">
            ...
            <div className="col-sm-12 col-lg-6 mb-3">
                <ProjectCard text={'Lorem ipsum, etc.Lorem ipsum, etc.Lorem ipsum, etc.Lorem ipsum, etc.Lorem ipsum, etc.Lorem ipsum, etc.Lorem ipsum, etc.Lorem ipsum, etc.Lorem ipsum, etc.Lorem ipsum, etc.'} title={'Em Desenvolvimento'} image={require('assets/comingsoon.jpeg')}/>
            </div>
            </div>
        </div>
    )
